...
preserve
	...
	* trimming (the 2th and 98th percentiles)
	drop if beta > 2.12518836
	drop if beta < -2.10169928
...
preserve
	...
	drop if phi > 0.22701136
	drop if phi < -0.224266748	
...
gen inc_g = 0
replace inc_g = 1 if nit <= 575
replace inc_g = 2 if nit > 575 & nit <= 1150
replace inc_g = 3 if nit > 1150 & nit <= 1725
replace inc_g = 4 if nit > 1725 & nit <= 2300
replace inc_g= 5 if nit > 2300 & nit <= 2875
...
gen beta_g = 0
replace beta_g = 1 if nit <= 575
replace beta_g = 2 if nit > 575 & nit <= 1150
replace beta_g = 3 if nit > 1150 & nit <= 1725
replace beta_g = 4 if nit > 1725 & nit <= 2300
replace beta_g = 5 if nit > 2300 & nit <= 2875
